...
import { Text, StyleSheet, View, StatusBar, useColorScheme, TextInput, TouchableOpacity, Dimensions } from 'react-native'
    ...
    return (
      <SafeAreaView edges={["top", "right", "left"]} style={styles.container}>
        <LinearGradient style={styles.gradient} colors={["#dedae6","#cfbede","#8381bd", "#8381bd","#cfbede","#dedae6"]} locations={[0,.1,.3,.7, .9, 1]}>
            <View style={styles.mainTextContainer}>
                ...
                <View style={styles.secondaryTextContainer}>
                    <Text style={[styles.text, styles.secondaryText]}>Already Registered? Log in </Text>
        ...
        <View style={styles.form}>
            ...
            <Button style={styles.button} text="Sign Up" class="primary" Style={{width: 300}}/>
            </View>
        </View>
        </LinearGradient>
